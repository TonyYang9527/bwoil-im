...
public class IndexController {
     ...
     * @param headers
     */
    @MessageMapping("/connect") //"/hello"为WebSocketConfig类中registerStompEndpoints()方法配置的
    ...
    public Greeting handleSubscribe() {
        ...
        return new Greeting("handleSubscribe : I am a msg from SubscribeMapping('/macro').");
    }
    ...
    public Greeting send() {
        ...
        logger.info("send :this is the @SubscribeMapping('/marco')");
        return new Greeting("send: I am a msg from SubscribeMapping('/macro').");
    }
